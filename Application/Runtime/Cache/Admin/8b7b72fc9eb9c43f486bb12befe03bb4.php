...
<div class="pd-20" style="padding-top:20px;">
  ...
  <p>登录次数：<?php echo ($login_num); ?> </p>
  <p>上次登录IP：<?php echo ($login_ip); ?>  上次登录时间：<?php echo (date('Y-m-d H:i:s',$login_time)); ?></p>
  <table class="table table-border table-bordered table-bg">
    ...
    <tbody>
      ...
      <tr class="text-c">
        <td>今日</td>
        <td><?php echo ($day_news_count); ?></td>
        <td><?php echo ($day_pic_count); ?></td>
        <td><?php echo ($day_goods_count); ?></td>
        <td><?php echo ($day_users_count); ?></td>
        <td><?php echo ($day_admin_count); ?></td>
        <td><?php echo ($day_order_count); ?></td>
      </tr>
     <!-- <tr class="text-c">
        <td>昨日</td>
        <td>0</td>
